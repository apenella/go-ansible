...
func TestGenerateAnsibleAdhocOptions(t *testing.T) {
	...
	expected := []string{
		...
		"--check",
		"--diff",
		"--extra-vars={\"var1\":\"value1\",\"var2\":false}",
		"--extra-vars=@extra-vars-file.yml",
		"--forks=10",
		"--inventory=127.0.0.1,",
		"--limit=myhost",
		"--list-hosts",
		"--module-name=module-name",
		"--module-path=/dev/null",
		"--one-line",
		...
		"--connection=local",
		"--private-key=pk",
		"--scp-extra-args=scp-extra-args1 scp-extra-args2",
		"--sftp-extra-args=sftp-extra-args1 sftp-extra-args2",
		"--ssh-common-args=ssh-common-args1 ssh-common-args2",
		"--ssh-extra-args=ssh-extra-args1 ssh-extra-args2",
		"--timeout=10",
		"--user=user",
		"--ask-become-pass",
		"--become",
